...
system.time({
countTables=countAmplicons(in.con, index.key, amplicons, line.buffer=5e7, nthreads=1)
})
...
countTables2=countAmplicons(in.con, index.key, amplicons, line.buffer=4e6, max.lines=1e6, nthreads=4)
